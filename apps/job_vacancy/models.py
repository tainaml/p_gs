...
class JobVacancy(models.Model):
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, null=False, related_name='job_vacancys', verbose_name=_('Author'))
    job_vacancy_responsibility = models.TextField(null=True, max_length=10000, verbose_name=_('Responsibility Description'))
    ...
    benefits = models.ManyToManyField(Benefit, blank=True, null=True, verbose_name=_('Benefits'))
...
class JobVacancyLocation(models.Model):
    job_vacancy = models.ForeignKey(JobVacancy, null=False, related_name='locations',on_delete=models.CASCADE, blank=False, verbose_name=_('Job Vacancy'))
    country = models.ForeignKey(Country, verbose_name=_('Country'))
    state = ChainedForeignKey(State, chained_field="country", chained_model_field="country", show_all=False, auto_choose=True, verbose_name=_('States'))
...
class Salary(models.Model):
    ...
    job_vacancy = models.OneToOneField(JobVacancy, on_delete=models.CASCADE, related_name='salary', primary_key=True, verbose_name=_('Job Vacancy'))
...
class JobVacancyResponsibility(models.Model):
    ...
    responsibility_type = models.ForeignKey(JobVacancyResponsibilityType, null=True, verbose_name=_('Responsibility Type'))
    job_vacancy = models.OneToOneField(JobVacancy, on_delete=models.CASCADE, related_name='resposibility', primary_key=True, verbose_name=_('Job Vacancy'))
...
class Requirement(models.Model):
    ...
    job_vacancy = models.ForeignKey(JobVacancy,on_delete=models.CASCADE, related_name='requirements', null=False, verbose_name=_('Job Vacancy'))
...
class JobVacancyCertification(models.Model):
    ...
    job_vacancy = models.ForeignKey(JobVacancy, on_delete=models.CASCADE, related_name='certifications', null=False, verbose_name=_('Job Vacancy'))
