...
class JobVacancy(models.Model):
    ...
    regime = models.ForeignKey(JobRegime, null=True, verbose_name=_('Regime'))
    home_office = models.BooleanField(verbose_name=_('Home Office'))
    quantity = models.PositiveIntegerField(null=True, verbose_name=_('Quantity'))
    workload =  models.ForeignKey(WorkLoad, null=True, verbose_name=_('Work Load'))
    states = models.ManyToManyField(State, verbose_name=_('States'))
    cities = models.ManyToManyField(City, verbose_name=_('Cities'))
    benefits = models.ManyToManyField(Benefit, verbose_name=_('Benefits'))
    ...
    contact = models.TextField(null=True, max_length=10000, verbose_name=_('Contact'))
...
class Requirement(models.Model):
    ...
    job_vacancy = models.ForeignKey(JobVacancy, related_name='requirements', null=False, verbose_name=_('Job Vacancy'))
...
class JobVacancyCertification(models.Model):
    ...
    job_vacancy = models.ForeignKey(JobVacancy, related_name='certifications', null=False, verbose_name=_('Job Vacancy'))
