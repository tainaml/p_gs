...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('company', '0002_auto_20160323_1002'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cities', smart_selects.db_fields.ChainedManyToManyField(chained_field='state', chained_model_field='states', to='geography.City', verbose_name='Cidades')),
        ...
        migrations.AddField(
            ...
            name='job_vacancy',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='job_vacancy.JobVacancy', verbose_name='Vaga de trabalho'),
        ),
        migrations.AddField(
            model_name='jobvacancylocation',
            name='state',
