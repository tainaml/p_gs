...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='benefits',
            field=models.ManyToManyField(to='job_vacancy.Benefit', verbose_name='Benef\xedcios'),
        ),
        migrations.AlterField(
            model_name='jobvacancy',
            name='description',
        ...
        migrations.AlterField(
            model_name='jobvacancy',
            name='states',
            field=models.ManyToManyField(to='geography.State', verbose_name='Estados'),
        ),
        migrations.AlterField(
            model_name='jobvacancy',
            name='title',
        ...
        migrations.AlterField(
            model_name='jobvacancy',
            name='workload',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='job_vacancy.WorkLoad', verbose_name='Carga hor\xe1ria'),
        ),
        migrations.AlterField(
