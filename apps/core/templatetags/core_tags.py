...
def relevance_box(context, content_object, content_type="feedobject", count=5, template_path='core/partials/relevance/article-base.html'):

    try:
        records_type = ContentType.objects.get(model="feedobject")
