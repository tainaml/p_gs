(function(factory) {
  ...
  var summernotePrettyprint = function (context) {
    ...
    options.codeBeautify = $.extend(prettyprintOpitions, options.codeBeautify);
    ...
    this.createDialog = function ($container) {
      ...
      */
      ...
      var select = '<select class="form-control" id="code-language"><option>' + options.codeBeautify.languages.join('</option><option>') + '</option></select>';
